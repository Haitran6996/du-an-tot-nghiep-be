...
exports.login = exports.getToken = exports.createAdmin = exports.register = void 0;
...
const login = async (req, res) => {
    ...
    try {
        ...
        const userDelPass = await database_services_1.default.users.find({ username }).select('-password -refreshToken');
        const payload = {
